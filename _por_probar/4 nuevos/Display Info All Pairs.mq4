...
//---------------------        
      string tstr1 = ast0 + ReduceCcy(ccy) + NumberToStr(bidp,msk) + NumberToStr(tdy,"R5") + NumberToStr(adr,"':'R3") + NumberToStr(-pctadr,"R(4%") 
                   + ast1 + NumberToStr(spr,"4.1") + ast2 + NumberToStr(-pctspr,"R(~2.1%") + ast3 + NumberToStr(tickval,"R4.2");
...
//---------------------        
      ...
      color colr  = Gray;
      if (StringFind("EURUSD,GBPUSD,USDCHF,NZDUSD,AUDUSD,USDJPY,USDCAD,NZDJPY,AUDJPY,GBPJPY,",ccy+",",0) >= 0)      
        colr = FontColor;      
