...
#property indicator_maximum 100.5
#property indicator_minimum 99.5
...
{ 
    ...
    IndicatorShortName(" HMA_Momentum_Test1 ( "+period+" )"); 
    return(0); 
} 
...
{ 
    ...
    for(x = 0; x < e-period; x++)
        ...
        ExtMapBuffer[x] = iMomentumOnArray(vect, 0, p, x);
