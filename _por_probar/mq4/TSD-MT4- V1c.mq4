...
Comment("TSD for MT4 ver beta 0.1 - DO NOT USE WITH REAL MONEY YET",
        "\n",
        "\n","Weekly MacdPrevious = ",MacdPrevious,
        "\n","Weekly MacdPrevious2 = ",MacdPrevious2,
        ...
        "\n",
        "\n","Daily PriceOpen = ",PriceOpen,
        "\n","Daily NewPrice = ",NewPrice,
        "\n",
        "\n","Daily High[1] = ",High[1],
        "\n","Daily High[2] = ",High[2],
        "\n","Daily Low[1] = ",Low[1],
