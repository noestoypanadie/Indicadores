...
extern bool UseMAHighLow= true;
extern int MA_HL_Mode = 1;
extern int MA_HL_Period = 9;
extern int MA_HL_BuyPrice = 5;  // Price typical
extern int MA_HL_SellPrice = 1;  // Price Open
...
double GetStopLossSell(int which)
{
  ...
  case 2 : SL = iSAR(NULL,SignalTimeFrame,0.02,0.2,SignalCandle);           // Parabolic Sar Current
           break;
//  case 3 : SL = CalculateNextSupport();
//           break;
  }
  return(SL);
} 
