...
extern double LotsIfNoMM = 0.2;
extern int TakeProfit = 300;
extern int Stoploss = 55;
extern int TrailingStop = 65;	
extern int EveryTwelveHoursUntilBEtrail = 1;	
extern int EveryTwelveHoursAfterBEtrail = 39;	
extern int EntryDistanceFromBar = 5;	
extern int StopDistanceFromBar = 5;	
extern int WPRperiod=29;		
extern int Slippage=5;			// Slippage
extern int MM_Mode=0,MM_Risk=10;
