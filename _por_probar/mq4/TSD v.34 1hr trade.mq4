...
// trading periods
extern int PeriodDirection = PERIOD_D1, PeriodTrade = PERIOD_H4, PeriodTrailing = PERIOD_H1, CandlesTrailing = 3;
// currency pairs to trade
string pairs[] = { "AUDUSD", "EURCHF", "EURGBP", "EURJPY", "EURUSD", "GBPCHF", "GBPJPY", "GBPUSD",
                   "USDCAD", "USDCHF", "USDJPY" };

// MM and broker parameters
extern int Broker = BROKER_METAQUOTES;
extern double Risk = 0.02, Lots = 0.1;
