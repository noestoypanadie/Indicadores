...
//|                                                                  | 
//+------------------------------------------------------------------+
/*if you load the proscource indicator and the nrtr
indicators it enters when the 2 lines are at top 
to sell and 2 lines at bottom to buy

when either one of the lines changes "sides' it will
close

if you chose not to use nrtr then it just uses the
lines in the prosourse indicator.

the arrows arent used at all*/
// Version 1.3 
#include <stdlib.mqh>
