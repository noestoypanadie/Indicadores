...
// user input
extern double ProfitMade   =       4;    // how much money do you expect to make
extern double LossLimit    =      37;    // how much loss can you tolorate
extern double BDistance    =       5;    // plus how much
extern int    BPeriod      =       3;    // Bollinger period
...
extern bool   logtick      =    true ;   // log tick data while orders open (or not)
