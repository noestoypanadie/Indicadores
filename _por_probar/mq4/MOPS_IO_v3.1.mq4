...
if ((BuyThisSymbol==false) && (Hour()==OpenStartHour1 + BrokerOffsetToGMT) && (MarketInfo(Symbol(),MODE_SWAPLONG)>0)) 
{
BuyThisSymbol = true;
}

if ((SellThisSymbol==false) && (Hour()==OpenStartHour1 + BrokerOffsetToGMT) && (MarketInfo(Symbol(),MODE_SWAPSHORT)>0)) 
{
SellThisSymbol = true;
}
