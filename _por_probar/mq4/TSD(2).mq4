...
//---- change here to revert to original
	WPRs    = iWPR(NULL,PERIOD_D1,WilliamsP,1) > WilliamsL; //-75
	WPRb    = iWPR(NULL,PERIOD_D1,WilliamsP,1) < WilliamsH; //-25
   
   condBuy  = (wDir == 1 && WPRb &&
              iWPR(NULL,PERIOD_D1,WilliamsP,0) < iWPR(NULL,PERIOD_D1,WilliamsP,1) );
...
int getDirection()
   ...
   MacdP   = iOsMA(NULL,PERIOD_W1,12,26,9,PRICE_CLOSE,1);
   MacdP2  = iOsMA(NULL,PERIOD_W1,12,26,9,PRICE_CLOSE,2);
