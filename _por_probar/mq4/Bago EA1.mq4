...
*/               
               ticket=OrderSend(Symbol(),OP_BUY,TotalLots,Ask,3,Ask-HardStopLoss*Point,0,"Bago",Magic1,0,Green);
...
*/       
               ticket=OrderSend(Symbol(),OP_SELL,TotalLots,Bid,3,Bid+HardStopLoss*Point,0,"Sidus",Magic2,0,Red);
