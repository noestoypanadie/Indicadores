...
string pairs[] = { "AUDUSD m", "EURCHF m", "EURGBP m", "EURJPY m", "EURUSD m", "GBPCHF m", "GBPJPY m", "GBPUSD m",
                   "USDCAD m", "USDCHF m", "USDJPY m" };
...
int start() {
   ...
   if(TradeSymbol=="AUDUSD m")Spread=5 * SPoint;
   if(TradeSymbol=="EURCHF m")Spread=7 * SPoint;
   if(TradeSymbol=="EURGBP m")Spread=4 * SPoint; 
   if(TradeSymbol=="EURJPY m")Spread=4 * SPoint; 
   if(TradeSymbol=="EURUSD m")Spread=2 * SPoint; 
   if(TradeSymbol=="GBPCHF m")Spread=8 * SPoint; 
   if(TradeSymbol=="GBPJPY m")Spread=8 * SPoint; 
   if(TradeSymbol=="GBPUSD m")Spread=4 * SPoint;
   if(TradeSymbol=="USDCAD m")Spread=5 * SPoint;
   if(TradeSymbol=="USDCHF m")Spread=4 * SPoint;
   if(TradeSymbol=="USDJPY m")Spread=3 * SPoint;
...
double PipCost (string TradeSymbol) {
   ...
   if      ( TradeSymbol == "EURCHF m" || 
             TradeSymbol == "USDCHF m" )  Cost = 10/  MarketInfo("USDCHF m",MODE_BID);
   else if ( TradeSymbol == "EURGBP m" )  Cost = 10*  MarketInfo("GBPUSD m",MODE_BID);
   else if ( TradeSymbol == "CHFJPY m" ||
             TradeSymbol == "EURJPY m" ||
             TradeSymbol == "USDJPY m" )  Cost = 1000/MarketInfo("USDJPY m",MODE_BID);
   else if ( TradeSymbol == "AUDUSD m" ||
             TradeSymbol == "EURUSD m" ||
             TradeSymbol == "GBPUSD m" ||
             TradeSymbol == "NZDUSD m" )  Cost = 10;
   else if ( TradeSymbol == "GBPCHF m" )  Cost = PipCost("GBPUSD m")     / MarketInfo("USDCHF m",MODE_BID);
   else if ( TradeSymbol == "GBPJPY m" )  Cost = PipCost("GBPUSD m")*100 / MarketInfo("USDJPY m",MODE_BID);
   else if ( TradeSymbol == "EURCAD m" ||
             TradeSymbol == "USDCAD m" )  Cost = 10/  MarketInfo("USDCAD",MODE_BID);
   else                                 Cost = 10;
   ...
   if ( Broker == BROKER_ALPARI || Broker == BROKER_METAQUOTES ||
      ...
      if      ( TradeSymbol == "AUDUSD m" )  Cost = 20;
      else if ( TradeSymbol == "GBPUSD m" )  Cost = 7;
   }
