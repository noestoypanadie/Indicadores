...
bool BuySignal()
{
   double proup,NRTRup,prodownb4,NRTRdownb4;
     ...
     {
       if (Wait_For_Fresh_Cross)
       {
          if (prodownb4<9999 && NRTRdownb4>0) return(true);
       }
       else return(true);
...
bool SellSignal()
{
   double prodown,NRTRdown,proupb4,NRTRupb4;
     ...
     if (prodown<9999 && NRTRdown>0)
     {
       if (Wait_For_Fresh_Cross)
       {
         if (proupb4<9999   && NRTRupb4>0)   return(true);
       }
       else
        return (true);
     }
