...
bool darkcloudcover()   {  if(Open[2]<Close[2] &&
                              Open[1]>Close[1] &&
                              High[2]-Close[2]<Close[2]-Open[2]>Open[2]-Low[2] &&
                              High[1]-Open[1]<Open[1]-Close[1]>Close[1]-Low[1] &&
                              Open[1]>Close[2] &&
...
bool piercingpattern()  {  if(Open[2]>Close[2] &&
                              Open[1]<Close[1] &&
                              High[2]-Open[2]<Open[2]-Close[2]>Close[2]-Low[2] &&
                              High[1]-Close[1]<Close[1]-Open[1]>Open[1]-Low[1] &&
                              Open[1]<Close[2] &&
