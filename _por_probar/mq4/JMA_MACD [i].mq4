...
//+------------------------------------------------------------------+
#property  copyright "Copyright © 2005, scorpion."
...
extern int FastJMAPhrase=0;
extern int SlowJMAPhrase=0;
//---- indicator buffers
double     ind_buffer1[];
double     ind_buffer2[];
...
//---- name for DataWindow and indicator subwindow label
   IndicatorShortName("JMA MACD("+FastJMA+","+SlowJMA+","+SignalSMA+")");
   SetIndexLabel(0,"JMAMACD");
...
//---- macd counted in the 1-st buffer
   for(int i=0; i<limit; i++)
      ind_buffer1[i]= iCustom(NULL,0,"JMA",FastJMA,FastJMAPhrase,0,i) - iCustom(NULL,0,"JMA",SlowJMA,SlowJMAPhrase,0,i);
