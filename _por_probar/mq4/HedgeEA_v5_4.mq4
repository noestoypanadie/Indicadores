...
//v5 latest greatest version by kokas
...
extern double     Bollinger_Period = 1440;           // Period must be in minutes
...
// Long/Short   
     ...
     if((Order1==0 || Order2==0) && Symbol1isLong && !Symbol2isLong && !StopManageAcc && signal1 && signal2){
