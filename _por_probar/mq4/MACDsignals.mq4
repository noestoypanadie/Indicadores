...
//---- name for DataWindow and indicator subwindow label
   IndicatorShortName("MACDsignals("+FastEMA+","+SlowEMA+","+SignalSMA+")");
//---- initialization done
   return(0);
  }
//+------------------------------------------------------------------+
   ...
   for(i=0; i<limit; i++)
      {
         ...
         prev_value=ind_buffer2[i+1]-ind_buffer3[i+1];
         ...
         div_value1=MathAbs(div/prev_value);
         div_value2=MathAbs(div2/prev2_value);
         div_value3=MathAbs(div3/prev3_value);
         div=value-prev_value;
         div2=value-prev2_value;
         div3=value-prev3_value;
         if ((value>prev_value && prev_value<prev2_value && prev2_value<prev3_value && div_value1>DivCalc1) || 
             (value>prev_value && prev_value>prev2_value && prev2_value<prev3_value && div_value2>DivCalc2) ||
             (value>prev_value && (prev_value<prev2_value || prev_value>prev2_value) && prev2_value>prev3_value && prev3_value<prev4_value && div_value3>DivCalc3) || 
             (value>prev_value && prev_value>prev2_value && prev2_value>prev3_value && div_value1>DivCalc4) ) ind_buffer1a[i]=Low[i]-2*Point;
         if ((value<prev_value && prev_value>prev2_value && prev2_value>prev3_value && div_value1>DivCalc1) ||
             (value<prev_value && prev_value<prev2_value && prev2_value>prev3_value && div_value2>DivCalc2) ||
             (value<prev_value && (prev_value>prev2_value || prev_value<prev2_value)  && prev2_value<prev3_value && prev3_value>prev4_value && div_value3>DivCalc3) ||
             (value<prev_value && prev_value<prev2_value && prev2_value<prev3_value && div_value2>DivCalc4)) ind_buffer1b[i]=High[i]+2*Point;
      }   
//---- done
   return(0);
  }
