//+------------------------------------------------------------------+
//|                                   TSD_MR_Trade_OsMA_WPR_0_33.mq4 |
//|                                       Copyright ® 2005 Mindaugas |
//|                                           TSD Trade version 0.33 |
//|                                                                  |
...
bool TrailStop (int i, double TrailingStop) {
   ...
   if ( OrderType() == OP_BUY ) {
      ...
      StopLoss = iLow(TradeSymbol, PeriodTrailing, Lowest (TradeSymbol, PeriodTrailing, MODE_LOW, CandlesTrailing, 0)) - 1*SPoint;
   ...
   if ( OrderType() == OP_SELL ) {
      ...
      StopLoss = iHigh(TradeSymbol, PeriodTrailing, Highest (TradeSymbol, PeriodTrailing, MODE_HIGH, CandlesTrailing, 0)) + 1*SPoint
                 + Spread;
