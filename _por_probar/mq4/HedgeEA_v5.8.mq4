...
//---- input parameters
extern string     ExpertName       = "[5.8]";                       // Expert Name and first part of comment line
...
extern bool       UseAutoRatio     = false;
...
extern double     Risk             = 20;                            // 10%
extern bool       AutoProfit       = false;
extern double     APPercent        = 5;                             // Percentage of account balance to use as TakeProfit
...
ProfitTarget = APPercent * AccountBalance() / 100;
