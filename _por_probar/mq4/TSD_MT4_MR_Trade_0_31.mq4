//+------------------------------------------------------------------+
//|                                   TSD_MR_Trade_OsMA_WPR_0_31.mq4 |
//|                                       Copyright ® 2005 Mindaugas |
//|                                           TSD Trade version 0.31 |
//|                                                                  |
...
#define  BROKER_NEUREX        6
#define  BROKER_NEUREX_MINI   7
#define  BROKER_NEUREX_MICRO  8
...
double PipCost (string TradeSymbol) {
   ...
   if ( Broker == BROKER_ALPARI || Broker == BROKER_NEUREX || Broker == BROKER_NEUREX_MINI || Broker == BROKER_NEUREX_MICRO ) {
