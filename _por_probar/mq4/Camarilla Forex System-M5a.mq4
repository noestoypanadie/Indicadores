...
MoveObject("H4",OBJ_HLINE,Time, H4,Time, H4,Blue,1,STYLE_dot);
MoveObject("H3",OBJ_HLINE,Time,H3,Time,H3,Blue,1,STYLE_dot);
MoveObject("H1",OBJ_HLINE,Time,H1,Time,H1,MediumVioletRed,1,STYLE_DASH);
MoveObject("L1",OBJ_HLINE,Time,L1,Time,L1,MediumVioletRed,1,STYLE_DASH);
MoveObject("L3",OBJ_HLINE,Time, L3,Time, L3,Red,1,STYLE_dot);
MoveObject("L4",OBJ_HLINE,Time,L4,Time,L4,Red,1,STYLE_dot);


SetObjectText("H4_txt","Get Out Here ","Arial",7,White);
MoveObject("H4_txt",OBJ_TEXT,Time,H4,Time,H4,White);

SetObjectText("H3_txt","Buy Here ","Arial",7,White);
MoveObject("H3_txt",OBJ_TEXT,Time,H3,Time,H3,White);

SetObjectText("H1_txt","Stop Loss for Short ","Arial",7,White);
MoveObject("H1_txt",OBJ_TEXT,Time,H1,Time,H1,White);

SetObjectText("L1_txt","Stop Loss for Long ","Arial",7,White);
MoveObject("L1_txt",OBJ_TEXT,Time,L1,Time,L1,White);

SetObjectText("L3_txt","Sell Here ","Arial",7,White);
MoveObject("L3_txt",OBJ_TEXT,Time,L3,Time,L3,White);

SetObjectText("L4_txt","Get Out Here ","Arial",7,White);
MoveObject("L4_txt",OBJ_TEXT,Time,L4,Time,L4,White);



OpenTrades=0;
for(cnt=1;cnt<=TotalTrade;cnt++)s{
